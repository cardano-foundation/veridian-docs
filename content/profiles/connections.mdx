...
This QR code can be scanned from the connetions page (center right tab button) of the wallet.
...
### Share our profile
You will be ready to complete the connection if you've created [a profile](./profiles).
From within the profile details, you can use the share button to view your connection QR code.
