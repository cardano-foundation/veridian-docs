...
Let's connect!
Note that, we currently only support signing from Individual profiles, with support for Group profiles coming later.
Please refer to [this page](../profileCreation#individual-profile) to create an Individual profiles.

<Steps>
### Navigate to Cardano Connect

In the Veridian Wallet, on the home page, select the `Cardano connect` tile.

### Connect

Clicking the `Connect using Cardano` button will activate your camera.
...
You can review all of the information before committing to signing anything, and you will be prompted to enter your passcode or password for final confirmation.
...
<video src="https://ucarecdn.com/6819f150-c513-42db-91d2-147e5a94dd6b/" type="video/mp4" controls />
