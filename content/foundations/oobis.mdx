...
To help us, we have something known as an [out of band introduction](https://trustoverip.github.io/kswg-keri-specification/#out-of-band-introduction-oobi).
...
In fact, all data at this endpoint is signed at rest using KERI's [BADA policy](https://trustoverip.github.io/kswg-keri-specification/#bada-best-available-data-acceptance-policy) which aligns with zero trust network architecture.
