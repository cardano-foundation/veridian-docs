...
KERIA runs CESR parser which can parse KERI and CESR events.
These events can be user triggered (e.g. creating an identifier) or they could be received from the public endpoint from other KERI agents trying to interact with you.
