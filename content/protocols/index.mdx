...
The [KERI whitepaper](https://github.com/SmithSamuelM/Papers/blob/master/whitepapers/KERI_WP_2.x.web.pdf) is over 140 pages long and has resulted in three separate specifications in Trust over IP: [KERI](https://trustoverip.github.io/kswg-keri-specification/), [ACDC](https://trustoverip.github.io/kswg-acdc-specification/) and [CESR](https://trustoverip.github.io/kswg-cesr-specification/).
...
The schema or format of the data container is referenced within the ACDC as a [SAID](https://trustoverip.github.io/kswg-cesr-specification/#self-addressing-identifier-said), which prevents security issues prevalent in other Verifiable Credential protocols that rely on web-hosted JSON schema URLs.
