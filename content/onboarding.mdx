...
- **Android:** Version 14 — Upside Down Cake (API level 34)
...
Once loaded, you can click `Get started` and proceed to read and accept apps the terms of use and privacy policy.

 
### Create a PIN
Choose a secure PIN.
This PIN will be used to access the app and may be used to perform critical actions within the app. This PIN will be the same for all the profiles across the wallet.

If your phone supports it, you will be asked to optionally set up biometrics too!
Biometrics may be used instead of the PIN or password (see below).
...
Once enabled, it will replace the PIN for performing critical actions when the app is unlocked.
The PIN will still be used to unlock the app.

### Connect to Veridian
Scan your onboarding QR code.
...
<Callout type="info">
  Developers may choose to use the "Advanced setup" to directly enter the boot and connect URLs of the cloud agent.
</Callout>
</Steps>
