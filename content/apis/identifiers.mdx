...
Witnesses run the [KAWA](https://trustoverip.github.io/kswg-keri-specification/#keris-algorithm-for-witness-agreement-kawa) algorithm for consensus but the thresholds **must** be set correctly for it to function correctly.
