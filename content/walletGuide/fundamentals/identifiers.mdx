...
The ultimate goal is to keep your idnetifiers for life.
...
<Callout type="warning" emoji="⚠️">
  #Animation 3: Create single identifier. Rotate key of single identifier
</Callout>

<Callout type="warning" emoji="⚠️">
  #Animation 4: Create multi-sig identifier with threshold
</Callout>

<Callout type="warning" emoji="⚠️">
  #Animation 5: Delete a single identifier
</Callout>
