...
Let's connect!
Note that we currently only support signing from Individual profiles.
Please refer to [this page](../profiles/creatingaprofile#individual-profile) to create an Individual profile.

<Steps>
### Navigate to Cardano connect

From the home page, select the `Cardano connect` tile.
