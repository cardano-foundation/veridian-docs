...
They follow a well-defined schema with certain attributes — which we call a credential template.
...
Check out the [previous page](./connections) if you haven't already set up the connection.
...
You can even present revoked credentials — this is because some credentials might have a revocation grace period, or there might be some use-case where you need to present it for auditing purposes after revocation.
