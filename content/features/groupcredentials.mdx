...
Group profiles can also hold and manage credentials!
...
However, only **one** group member needs to share the group QR code (from the profile details share screen) with the issuer tool.
...
In case a group member doesn't receive one, or the connection name is `Unknown`, it means that they forgot to scan the issuer's QR code within their wallet, or have since deleted the connection.
...
<video src="https://ucarecdn.com/ae73fcdc-e76c-4203-8a4b-dc0cc9a684ae/" className="wide-asset" type="video/mp4" controls />
...
- You have not accepted the credential yet, but the group as a whole has and the threshold was met.
...
<video src="https://ucarecdn.com/1381220f-f74f-4328-acd9-08d744eda609/" className="wide-asset" type="video/mp4" controls />
