...
In any case, we try to make it as easy and simple to go from zero to orchestrating all the services and serving them behind HTTPS to keep web2 compatibility, although obviously, the end-goal is to get rid of this need while enabling ToIP (Trust over IP) using KERI. 
