...
- A cloud instance or k8s cluster with enough resources to run the services. We recommend _as very minimum_ 4vCPU, 8GB of RAM and 20GB of storage to start with.
