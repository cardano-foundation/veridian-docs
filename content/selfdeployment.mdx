...
In any case, we try to make it as easy and simple to go from zero to orchestrating all the services and serving them behind HTTPS to keep web2 compatibility, although obviously, the end-goal will be to get rid of this need while enabling ToIP (Trust over IP) using KERI. 

## Common pre-requisites

- You will need a registered DNS domain. We reference it as `PUBLIC_DOMAIN` but it's fine as long as it's reachable from your wallet app and the server(s) you will be deploying to.
