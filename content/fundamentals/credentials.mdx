...
ACDC schemas may define weighted edges in a property graph with certain properties, effectively chaining ACDCs together cryptographically.
This allows us to represent delegated authority, or provide provenance and chains-of-custody for any data we want.

<Callout type="warning" emoji="⚠️">
  #Animation 8: Receive credential
</Callout>

<Callout type="warning" emoji="⚠️">
  #Animation 9: Present credential
</Callout>

<Callout type="warning" emoji="⚠️">
  #Animation 10: Remove credential
</Callout>
