...
<div className="galery-container">
  <Image
    src="/img/more/group-identifier/group-identifier-1.png"
    width={350}
    height={300}
  />
  <Image
    src="/img/more/group-identifier/group-identifier-2.png"
    width={350}
    height={300}
  />
</div>
...
Below the QR code you may also see the current members you have connected with.
These connections will only appear here and not in the main connections list in the wallet.

<Image
    src="/img/more/group-identifier/group-identifier-3.png"
    width={350}
    height={300}
  />

<Callout type="info">
  While sharing the QR codes, this identifiers will appear in a "For groups"
  section in the identifiers tab. It is effectively in a draft state at this
  point until the initiator decides it's time to finalise the creation.
</Callout>
...
<Image
    src="/img/more/group-identifier/group-identifier-4.png"
    width={350}
    height={300}
  />
...
<div className="galery-container">
  <Image
    src="/img/more/group-identifier/group-identifier-5.png"
    width={350}
    height={300}
  />
  <Image
    src="/img/more/group-identifier/group-identifier-6.png"
    width={350}
    height={300}
  />
</div>
...
<Callout type="info">
  If some connections are missing, those members will be prompted to finish
  scanning before they can accept the final configuration.
</Callout>
