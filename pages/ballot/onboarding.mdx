...
The Identity Wallet uses a passcode to secure the wallet and to confirm certain actions. Enter and re-enter the 6-digit passcode to confirm its accuracy.
...
You can create an optional operations password as a more secure alternative to the passcode. Once you enable this password, you will need to use it instead of the passcode for certain operations. The passcode or biometrics will still be used to unlock the app.
...
Now it’s time to generate the recovery phrase. This phrase will help you recover your identity if you ever lose your phone or switch to another device.
...
The Identity Wallet leverages a cloud agent that runs KERI protocols and interfaces with other agents on the internet. For the Alpha Program, we have provided access to a cloud agent for participants. You can find the specific Boot and Connect URLs in the email that was distributed. Alternatively, you are free to run your own infrastructure.
...
The final step in the onboarding process is to enter your display name. When connecting to other wallets and services, this name will be shared.
