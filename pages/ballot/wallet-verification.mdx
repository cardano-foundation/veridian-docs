...
![](/img/ballot/verification/wallet-verification-1.png)

A pop-up window will appear to initiate the verification process. Click the "Verify" button.

![](/img/ballot/verification/wallet-verification-2.png)
...
![](/img/ballot/verification/wallet-verification-3.png)
...
![](/img/ballot/verification/discord/wallet-verification-discord-1.png)

In the Verification channel, react to the message using a rocket emoji to unlock the other channels in the server.

![](/img/ballot/verification/discord/wallet-verification-discord-2.png)
...
![](/img/ballot/verification/discord/wallet-verification-discord-3.png)
...
![](/img/ballot/verification/discord/wallet-verification-discord-4.png)
...
![](/img/ballot/verification/wallet-verification-4.png)
...
![](/img/ballot/verification/sms/wallet-verification-sms-1.png)

![](/img/ballot/verification/sms/wallet-verification-sms-2.png)

Once the verification code is received, enter it in the Cardano Ballot menu and click the "Confirm" button.

![](/img/ballot/verification/sms/wallet-verification-sms-3.png)
