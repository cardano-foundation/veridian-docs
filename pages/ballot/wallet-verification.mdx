...
In the top left corner of the Cardano Ballot window, click on the wallet button and select the "Verify Wallet" option. A pop-up window will appear to initiate the verification process.
...
For SMS verification, Cardano Ballot will need a phone number for two-factor authentication. Enter the phone number and request a phone number.
